        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-200">
                ...
                <div class="md:flex md:justify-between md:items-center py-5">
                    <div class="md:flex-1">
                        <a class="text-3xl font-extrabold text-gray-600" href="{{route('vacante.show', $vacante->id)}}">
                            {{$vacante->titulo}}
                        </a>
                    ...
                    <div class="mt-5 md:mt-0">
                        <a class="text-sm uppercase font-bold bg-blue-800 p-3 text-white rounded-lg block text-center"
